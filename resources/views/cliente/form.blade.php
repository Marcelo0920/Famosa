<br>
                ...
                <div class="form-floating mb-3">
                    <input type="text" placeholder="name" name="name" class="form-control" id="name" value="{{isset($cliente->name)?$cliente->name:old('name')}}">
                    <label for="exampleInputPassword1" class="form-label">Name Complete</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="integer" placeholder="ci" name="ci" class="form-control" id="ci" value="{{isset($cliente->ci)?$cliente->ci:old('ci')}}">
                ...
                <div class="form-check">
                    ...
                    @if ((isset($cliente->sexo)?$cliente->sexo:old('sexo')) == 'M')
                        checked
                    @endif>
                ...
                <div class="form-check">
                    ...
                    @if ((isset($cliente->sexo)?$cliente->sexo:old('sexo')) == "F")
                        checked
                    @endif>
                ...
                <div class="form-floating mb-3">
                    <input type="integer" placeholder="telefono" name="telefono" class="form-control" id="telefono" value="{{isset($cliente->telefono)?$cliente->telefono:old('telefono')}}">
                    <label for="exampleInputPassword1" class="form-label">Phone</label>
                </div>
                
                <div class="form-floating mb-3">
                    <input type="email" placeholder="email" name="email" class="form-control" id="email" value="{{isset($cliente->email)?$cliente->email:old('email')}}" aria-describedby="emailHelp">
