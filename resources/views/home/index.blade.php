...
<section
      ...
      >
        <div class="swiper-wrapper text-sm-left">
          <div
            ...
            data-slide-bg="images/Pasta-Larga_FAMOSA_4-1.webp"
          >
                  ...
                  >
                    <h1 class="oh swiper-title">
                      <span
                        ...
                        >Fideos Perfectos</span
                      >
                    </h1>
                    <p
                      class="big swiper-text"
          ...
          <div
            class="swiper-slide context-dark"
            data-slide-bg="images/portada2.jpg"
          >
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure">
                    <img
                      src="images/Fideos a la Crema de Quesos.jpg"
                      alt=""
                      width="370"
                      height="278"
                    />
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure">
                    <img
                      src="images/Fideos con Boloñesa de Carne y Aceitunas.jpg"
                      alt=""
                      width="370"
                      height="278"
                    />
                  ...
                  <div class="services-terri-caption">
                  <!--   <span class="services-terri-icon linearicons-pizza"></span> -->
                    <h5 class="services-terri-title"><a href="#">Fideos con Boloñesa de Carne y Aceitunas</a></h5>
                  </div>
                </article>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure">
                    <img
                      src="images/Fideos con Pato.jpg"
                      alt=""
                      width="370"
                      height="278"
                    />
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure">
                    <img
                      src="images/Nankhatai (Galletas de Mantequilla de la India).jpg"
                      alt=""
                      width="370"
                      height="278"
                    />
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure">
                    <img
                      src="images/Pastel de Macarrones.jpg"
                      alt=""
                      width="370"
                      height="278"
                    />
      ...
      <!-- Section CTA-->
      <section
        class="primary-overlay section parallax-container"
        data-parallax-img="images/portada3.png"
      >
                ...
                <div class="cta-modern">
                  ...
                  <p class="cta-modern-text oh-desktop" data-wow-delay=".1s">
                    ...
                    ><span class="d-inline-block wow slideInDown"
                      >José María Vicente Vicario, Fundador</span
                    >
                  </p>
                  <a
          ...
          <div class="row row-lg row-30">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              ...
              <article class="product wow fadeInLeft" data-wow-delay=".1s">
                <div class="product-figure">
                  <img
                    src="images/Codo Grande Rigatti-1.jpg"
                    alt=""
                    width="161"
                    height="162"
                  />
      ...
      <section class="section section-xl bg-default">
        ...
        <div class="container container-style-1">
          <div
            class="owl-carousel owl-style-12"
            data-items="1"
            data-sm-items="2"
            data-lg-items="3"
            data-margin="30"
